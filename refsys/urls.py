...
urlpatterns = [
    ...
    path(
        'auth/verify_code/', views.VerifyCodeView.as_view(), name='verify_code'
    ),
    path(
        'auth/resend_code/', views.ResendCodeView.as_view(), name='resend_code'
    ),
    path(
        'verify_page/', TemplateView.as_view(template_name='verify_code.html')
    ),
    path(
